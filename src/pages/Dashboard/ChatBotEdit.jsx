    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                ...
                setSuccessModalOpen(true); // Abrir el modal de éxito
            } catch (error) {
    ...
    const formikRespuesta = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                ...
                setSuccessRespuestaModalOpen(true); // Abrir el modal de éxito para la respuesta
            } catch (error) {
                console.error('Error al actualizar la respuesta:', error);
                setErrorRespuestaModalOpen(true); // Abrir el modal de error para la respuesta
            }
        },
    });
