...
export const Publicaciones = () => {
  ...
  useEffect(() => {
    const filteredMicroList = microList?.filter((micro) => {
      return micro.nombre.toLowerCase().includes(busqueda);
    });
        ...
        <div>
          <section className="section-publications">
            <div className="text-container">
              ...
              <h3>
                Conocé cómo decisiones financieras pueden impactar positivamente
